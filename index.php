...
echo 'Local Maxima Indexes: '.implode(', ', $analyzer->getLocalMaximaIndexes()).'<br><br>';
...
echo 'Max Speed Index: '.$analyzer->getMaxSpeedIndex().'<br>';
echo 'Max Speed (km/h): '.$analyzer->getMaxSpeed().'<br>';
echo 'Max Acceleration Index: '.$analyzer->getMaxAccelerationIndex().'<br>';
echo 'Max Acceleration: '.$analyzer->getMaxAcceleration().' km/h per second<br>';
echo 'Max Deceleration Index: '.$analyzer->getMaxDecelerationIndex().'<br>';
